    ...
    <div className="bg-zinc-800 h-screen flex items-center justify-center">
      <div className="flex flex-col gap-6 items-center justify-center max-w-[540px] py-10 px-5 w-full bg-zinc-600">
        ...
        <form
          ...
          className="flex-1 flex flex-col items-center justify-between gap-5"
        >
          <Input
            type="email"
            id="email"
          ...
          <span onClick={handleRecoverPassword} className="text-zinc-300 cursor-pointer">
            Recuperar senha
          </span>
          </div>
        </form>
